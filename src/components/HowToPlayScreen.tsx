    ...
    >
      <section className="panel prose">
        <ol>
          ...
          <li>Choose <strong>Tilt On</strong>, tap <strong>Start Round</strong>, place the phone on your forehead, and hold still for 3, 2, 1.</li>
          <li>With Tilt On, tilt down for Correct or up to Pass, then return to the starting position.</li>
          <li>
        ...
        <p>
          ...
          automatically. Use <strong>Tilt Off</strong> in round setup for a
          button-controlled classroom round without motion calibration.
        </p>
        <p>
